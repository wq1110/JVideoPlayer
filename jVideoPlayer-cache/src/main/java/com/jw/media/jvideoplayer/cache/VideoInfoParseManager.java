...
import com.jw.media.jvideoplayer.cache.utils.VideoParamsUtils;
...
/**
 * Created by Joyce.wang on 2024/9/11 14:15
 *
 * @Description TODO
 */
public class VideoInfoParseManager {
    ...
    private void parseNetworkM3U8Info(VideoCacheInfo cacheInfo) {
        try {
            ...
            if (m3u8.isIsLive()) {
                ...
                cacheInfo.setVideoType(VideoCacheType.M3U8_TYPE);
    ...
    private void parseNonM3U8VideoInfoByOkHttp(VideoCacheInfo cacheInfo) {
        cacheInfo.setVideoType(VideoCacheType.OTHER_TYPE);
        long contentLength;
