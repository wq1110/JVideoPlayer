...
import com.jw.media.jvideoplayer.cache.common.ProxyMessage;
import com.jw.media.jvideoplayer.cache.common.VideoCacheConfig;
import com.jw.media.jvideoplayer.cache.common.VideoCacheException;
import com.jw.media.jvideoplayer.cache.common.VideoCacheType;
import com.jw.media.jvideoplayer.cache.listener.IVideoCacheListener;
import com.jw.media.jvideoplayer.cache.listener.IVideoCacheTaskListener;
import com.jw.media.jvideoplayer.cache.listener.IVideoInfoParsedListener;
import com.jw.media.jvideoplayer.cache.listener.VideoInfoParsedListener;
import com.jw.media.jvideoplayer.cache.m3u8.M3U8;
import com.jw.media.jvideoplayer.cache.model.VideoCacheInfo;
import com.jw.media.jvideoplayer.cache.okhttp.IHttpPipelineListener;
import com.jw.media.jvideoplayer.cache.okhttp.NetworkConfig;
import com.jw.media.jvideoplayer.cache.okhttp.OkHttpManager;
import com.jw.media.jvideoplayer.cache.proxy.LocalProxyVideoServer;
import com.jw.media.jvideoplayer.cache.task.M3U8CacheTask;
import com.jw.media.jvideoplayer.cache.task.Mp4CacheTask;
import com.jw.media.jvideoplayer.cache.task.VideoCacheTask;
...
/**
 * Created by Joyce.wang on 2024/9/11 14:17
 *
 * @Description TODO
 */
public class VideoProxyCacheManager {
    ...
    public void startRequestVideoInfo(String sourceId, String videoUrl, Map<String, String> headers, Map<String, Object> extraParams) {
        ...
        if (videoCacheInfo == null) {
            ...
            if (videoCacheInfo.getVideoType() == VideoCacheType.M3U8_TYPE) {
                //说明视频类型是M3U8类型
                final Object lock = VideoLockManager.getInstance().getLock(md5);
                final String finalMd5 = md5;
            ...
            } else if (videoCacheInfo.getVideoType() == VideoCacheType.M3U8_LIVE_TYPE) {
                //说明是直播
    ...
    private boolean shouldNotifyLock(int videoType, String sourceId, String url, String md5) {
        synchronized (mSeekPositionLock) {
            //只有非M3U8视频才能进入这个逻辑
            if (videoType == VideoCacheType.OTHER_TYPE && mVideoSeekMd5PositionMap.containsKey(md5)) {
