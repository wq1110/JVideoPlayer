package com.jw.media.jvideoplayer.cache.task;

import com.jw.media.jvideoplayer.cache.StorageManager;
import com.jw.media.jvideoplayer.cache.listener.IMp4CacheThreadListener;
...
import com.jw.media.jvideoplayer.cache.utils.VideoRangeUtils;
...
public class Mp4CacheTask extends VideoCacheTask {
    ...
    private void startVideoCacheThread(VideoRange requestRange) {
        ...
        ThreadUtils.submitRunnableTask(mVideoCacheThread);
    }
